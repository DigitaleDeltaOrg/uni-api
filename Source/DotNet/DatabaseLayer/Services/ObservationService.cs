		...
		try
		{
			...
			foreach (var observation in observations)
			{
				...
				var data = new List<string>
				{
					...
					ValueOrNull(observation.ObservedPropertyId),
					ValueOrNull(observation.ObservingProcedureId),
					ValueOrNull(observation.ObserverId),
					ValueOrNull(observation.HostId),
